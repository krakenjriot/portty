...
Upload Hex File
--------------------
Inside the package there is a folder named `xloader`, in it the applicaiton `xloader.exe` 
Select and right-click it to run it as administrator
...
one all settings are confirmed correct 

you can click upload and wait to complete
